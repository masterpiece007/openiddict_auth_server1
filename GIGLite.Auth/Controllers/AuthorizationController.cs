...
namespace GIGLite.Auth.Controllers
{
    ...
    public class AuthorizationController : ControllerBase
    {
        ...
        private readonly MyProjectDbContext _MyProjectDbContext;
        ...
        public async Task<IActionResult> Exchange(OpenIdConnectRequest request)
        {
            if (request.IsPasswordGrantType())
            {
                ...
                var employeeDetail = _MyProjectDbContext.Employees.FirstOrDefault(a => a.ApplicationUserId == user.Id);
        ...
        public async Task<IActionResult> Update(string userId, RegisterViewModel registration)
        {
            ...
            var _roleManager = new RoleManager<IdentityRole>(new RoleStore<IdentityRole>(_MyProjectDbContext), null, null, null, null);
        ...
        {
            var allUsers = _MyProjectDbContext.Employees.ToList();
            if (allUsers != null)
            {
                return Ok(allUsers);
        ...
        {
            var user = _MyProjectDbContext.Employees.FirstOrDefault(a => a.ApplicationUserId == userId);
            if (user != null)
            {
                return Ok(user);
            }
